let cal: boolean = false;
let memory: string;
let input = document.querySelector("#inputform") as HTMLInputElement;
let output = document.querySelector("#outputform") as HTMLInputElement;

/*
insert value and show in input form
value exist then append value 
*/
function insert(num: number | symbol) {
...
function getfunctionOption() {
  let selectElement = document.querySelector("#function") as HTMLSelectElement;
  let selectedvalue = selectElement.options[selectElement.selectedIndex].value;
...
*/
function square() {
  let newname = (<HTMLInputElement>document.getElementById("xsquare"))
    .innerHTML;
  if (newname == "x²") {
...
*/
function baseten() {
  let newname = (<HTMLInputElement>document.getElementById("tenx")).innerHTML;
...
*/
function sqrt2() {
  let newname = (<HTMLInputElement>document.getElementById("squareroot"))
    .innerHTML;
  if (newname == "√") {
...
function dividenumber(num: number) {
...
*/
function logfunction(num: number) {
  let text = input.value;
  let newname = (<HTMLInputElement>document.getElementById("logten")).innerHTML;
  if (newname == "log") {
    input.value = text + "(" + num + ")";
...
execute ln and e^x
*/
function lnfunction(num: number) {
  let text = input.value;
  let newname = (<HTMLInputElement>document.getElementById("lnx")).innerHTML;
  console.log(newname);
  if (newname == "ln") {
...
function expfunction(num: number) {
  let text = input.value;
  input.value = num + "(" + text + ")";
  output.value = String(Math.exp(Number(text)));
}
...
function degreefunction() {
  let elem = document.getElementById("degree") as HTMLInputElement;
...
function changefunction() {
  let elem = document.getElementById("functionchange") as HTMLInputElement;
...
function memorysavefunction() {
  (<HTMLInputElement>document.getElementById("memoryclear")).disabled = false;
  (<HTMLInputElement>document.getElementById("memoryread")).disabled = false;
  memory = output.value;
}
/*
